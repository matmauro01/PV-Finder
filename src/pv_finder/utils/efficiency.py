# rudimentary efficiency calculation used to gauge progress while training
# copied from https://gitlab.cern.ch/LHCb-Reco-Dev/pv-finder/-/blob/master/model/efficiency.py
